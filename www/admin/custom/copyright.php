...
$d = str_replace('/admin/custom/copyright.php','',$f);
...
<div class="panel panel-default magbtmz">
  <div class="panel-heading"><?=$title?>
    <div class="control">
      <button type="button" class="btn btn-default btn-xs" onClick="Load('/admin/custom/copyright.php?a=view')"><i class="icon-list-alt"></i><?=lg('View')?></button>
      <button type="button" class="btn btn-success btn-xs" onClick="Refresh()"><i class="icon-refresh"></i><?=lg('Refresh')?></button>
      <button type="button" class="btn btn-warning btn-xs" onClick="Load('/admin/custom/copyright.php?a=edit')"><i class="icon-edit"></i><?=lg('Edit')?></button>
    </div>
  </div>
...
<div class="panel panel-default magbtmz">
  <div class="panel-heading"><?=$title?>
    <div class="control">
      <button type="button" class="btn btn-default btn-xs" onClick="Load('/admin/custom/copyright.php?a=view')"><i class="icon-list-alt"></i><?=lg('View')?></button>
      <button type="button" class="btn btn-success btn-xs" onClick="Refresh()"><i class="icon-refresh"></i><?=lg('Refresh')?></button>
      <button type="button" class="btn btn-warning btn-xs" onClick="Load('/admin/custom/copyright.php?a=view')"><i class="icon-reply"></i><?=lg('Go Back')?></button>
    </div>
  </div>
  <div class="panel-body">
    <form id="Form<?=$guid?>" class="custom" action="/admin/custom/copyright.php?a=update" method="post">
      <dl class="horizontal">
      <?
	  $s = "SELECT * FROM $table WHERE `$key`='$id'";
	  if($r = $dx->get_row($s)){
...
<div class="panel panel-default magbtmz">
  <div class="panel-heading"><?=$title?>
    <div class="control">
      <button type="button" class="btn btn-default btn-xs" onClick="Load('/admin/custom/copyright.php?a=view')"><i class="icon-list-alt"></i><?=lg('View')?></button>
      <button type="button" class="btn btn-warning btn-xs" onClick="Load('/admin/custom/copyright.php?a=edit')"><i class="icon-reply"></i><?=lg('Go Back')?></button>
    </div>
  </div>
  <div class="panel-body">
    <p><?
    ...
    ?></p>
    <button type="button" class="btn btn-default btn-sm" onClick="Load('/admin/custom/copyright.php?a=view')"><i class="icon-play"></i> <?=lg('Continue')?></button>
  </div>
</div>
<? }?>
