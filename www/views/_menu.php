...
<header>
  <div class="box-menu--desktop d-sm-none d-md-block">
    <section class="topbar">
      <div class="container">
        <div class="row ">
          <div class="col gene-hotline">
            <!--span class="material-icons">phone</span--> 0909.916.696 -
            <!--span class="material-icons">phone</span--> 096.1800.180
          </div>
    ...
    <div class="box-content-menu">
      <div class="logo-header">
        <a href="<?=URL_Rewrite('')?>"><img src="<?=$web['logo']?>" alt="logo-music-new1.png" class="fix-pagespeed"></a>
      </div>
    </div>
